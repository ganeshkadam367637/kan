...
const Update_customer = () => {
    ...
    const [formData, setFormData] = useState({
        ...
        exchange: null, finance: null,  ccessories: null, coating: null, auto_card: null, extended_warranty: null, registration_fees: null, ccp: null, insurance: null,
    });

    const [files, setFiles] = useState({
        aadhar: null,  pan: null, voterId: null,
    });
        ...
        <div>
                        ...
                        <div className="page_title">
                           ...
                           <form onSubmit={handleSubmit}>
                              <div className="row">
                                 ...
                                 <div className="mt-2 col-md-4">
                                            <label>Finance:</label>
                                            <input type="radio" name="finance" value="yes" className="ml-2" checked={formData.finance === "yes"}    onChange={handleChange} /> Yes
                                            <input type="radio" name="finance" value="no" className="ml-2" checked={formData.finance === "no"} onChange={handleChange}/> No
                                            {formData.finance === "yes" && ( 
                                                <button type="button"className="btn btn-danger ml-3" onClick={handleShow}>View</button>
                                            )}
                                 </div>
                                 <div className="mt-2 col-md-4">
            ...
            {show && (
                <div className="modal fade show d-block" tabIndex="-1" role="dialog" style={{ backgroundColor: 'rgba(0,0,0,0.5)' }}>
                    <div className="modal-dialog" role="document" style={{ maxWidth: '1000px', width: '950px', height: '700px' }}>
                            ...
                            <form>
                                <div className="row">
                                    ...
                                    <div className="col-md-6">
                                        ...
                                        {formData.aadhar_path ? (
                                        <iframe 
                                            src={`http://localhost:5000/${formData.aadhar_path}`} 
                                    ...
                                    <div className="col-md-6">
                                        ...
                                        {formData.pan_path ? (
                                        <iframe 
                                            src={`http://localhost:5000/${formData.pan_path}`} 
                                            style={{ width: '240px', height: '100px' }} 
                                            title="PanCard Preview"
                                        />
                                        ) : 'N/A'}
                                    </div>
                                    <div className="col-md-6">
                                        ...
                                        {formData.voterId_path ? (
                                        <iframe 
                                            src={`http://localhost:5000/${formData.voterId_path}`} 
                                            style={{ width: '240px', height: '100px' }} 
                                            title="voterId Preview"
                                        />
                                        ) : 'N/A'}
                                    </div>
                                </div>
