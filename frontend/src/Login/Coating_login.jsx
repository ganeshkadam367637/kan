            ...
            <div className="container">
                <div className="center verticle_center full_height">
                    <div className="login_section">
                        ...
                        <h4 className="mt-4 text-center">Coating Manager Log In</h4>
                        <div className="login_form">
                            <form>
                                <fieldset>
                                    <div className="field">
                                        <label className="label_field">Role</label>
                                        <input type="text" defaultValue="Coating Manager" required readOnly />
                                    </div>
                                    <div className="field">
